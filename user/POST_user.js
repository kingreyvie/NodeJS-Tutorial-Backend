...
function  putUser(dbConnection, body, callback) {
	...
	let sqlData = [body.user_fname, body.user_lname, body.user_role, body.user_email];

	let sqlQuery =  'INSERT INTO user_tbl (user_fname, user_lname, user_role, user_email, user_isdel) '  +
	'VALUES (?, ?, ?, ?, 0)';
